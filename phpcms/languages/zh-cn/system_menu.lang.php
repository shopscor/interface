...
$LANG['interface document'] = '接口文档';
$LANG['interface package'] = '接口包';
$LANG['interface'] = '接口';
$LANG['interface package'] = '接口包管理';
$LANG['interface package lists'] = '接口包列表';
$LANG['add interface package'] = '添加接口包';
$LANG['interface manage'] = '接口管理';
$LANG['add interface'] = '新增接口';
?>